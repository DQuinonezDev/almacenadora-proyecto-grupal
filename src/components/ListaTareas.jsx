...
export const ListaDeTareas = (tarea) => {
    ...
    //Filter sirve para crear un nuevo arreglo, 
        //En este caso elimina lo que seria el arreglo 
        //que se esta seleccionando desde la vista
    
    //Luego en el setTareas se setean todos los datos
        //Eliminando el arreglo que se seleciono
    //Eliminando tareas
    const eliminarTarea = (tareaAEliminar) => {
        const nuevasTareas = tareas.filter(
            (tarea) => tarea !== tareaAEliminar
        );
